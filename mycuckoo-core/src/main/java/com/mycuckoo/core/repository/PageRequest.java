...
public class PageRequest implements Pageable, Serializable {
     ...
     * (non-Javadoc)
     *
     * @see com.mycuckoo.core.repository.Pageable#getPageSize()
     */
     ...
     * (non-Javadoc)
     *
     * @see com.mycuckoo.core.repository.Pageable#getPageNumber()
     */
     ...
     * (non-Javadoc)
     *
     * @see com.mycuckoo.core.repository.Pageable#getFirstItem()
     */
