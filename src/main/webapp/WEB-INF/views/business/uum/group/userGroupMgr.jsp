						...
						<div class="page-header">
							<form class="form-inline" name="searchForm" action="index">
								<div class="form-group">
									...
									<input type="text" class="form-control input-sm" name="roleName" value="${param.groupName}" placeholder=组名称 />
								</div>
	...
	<script type="text/javascript">
		jQuery(function($) {
			...
			function disEnable(flag) {
				...
				if (flag == status) {
					var msg = (flag != BasicConstant.OPT_DISABLE_LINK ? '此用户组已经启用!' : '此用户组已经停用!');
				...
				function disableEnalbeOpt(flag, id) {
					$.getJSON('disEnable', {id: id, disEnableFlag: flag}, function(json) {
						if(json.status) {
							var msg = (flag != BasicConstant.OPT_DISABLE_LINK ? '用户组启用成功!' : '用户组停用成功!');
