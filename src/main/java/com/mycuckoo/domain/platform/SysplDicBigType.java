 ...
 * @version 2.0.0
 */
public class SysplDicBigType implements Serializable { 
	...
	private List<SysplDicSmallType> sysplDicSmallTypes = Lists.newArrayList();
	...
	public SysplDicBigType(Long bigTypeId, String bigTypeName, String bigTypeCode,
			String memo, String status, String creator, Date createDate, List<SysplDicSmallType> sysplDicSmallTypes) {
		this.bigTypeId = bigTypeId;
	...
	public List<SysplDicSmallType> getSysplDicSmallTypes() {
		return this.sysplDicSmallTypes;
	}
	
	public void setSysplDicSmallTypes(List<SysplDicSmallType> sysplDicSmallTypes) {
		this.sysplDicSmallTypes = sysplDicSmallTypes;
	}
}
