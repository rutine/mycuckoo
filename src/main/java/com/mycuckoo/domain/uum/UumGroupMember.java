...
public class UumGroupMember  implements java.io.Serializable {
	...
	class UumGroupMemberComp implements Comparator<UumGroupMember>{
		public int compare(UumGroupMember uumGroupMember1, UumGroupMember uumGroupMember2) {
			return uumGroupMember1.getGroupMemberId().compareTo(uumGroupMember2.getGroupMemberId());
		}
	}
