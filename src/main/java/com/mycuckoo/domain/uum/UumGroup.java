...
public class UumGroup {
	...
	private List<UumGroupMember> uumGroupMembers = Lists.newArrayList();
	...
	public UumGroup(Long groupId, String groupType, String groupName,
			...
			List<UumGroupMember> uumGroupMembers) {
		this.groupId = groupId;
	...
	public List<UumGroupMember> getUumGroupMembers() {
		return this.uumGroupMembers;
	}

	public void setUumGroupMembers(List<UumGroupMember> uumGroupMembers) {
		this.uumGroupMembers = uumGroupMembers;
	}
}
