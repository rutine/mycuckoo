...
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='系统公告表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `sys_affiche`
--

LOCK TABLES `sys_affiche` WRITE;
/*!40000 ALTER TABLE `sys_affiche` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `sys_affiche` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `sys_attachment` (
  ...
  `busi_sub_type` int DEFAULT NULL COMMENT '业务子类型',
  ...
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`),
  KEY `idx_sys_attachment_busi` (`busi_type`,`busi_sub_type`,`busi_id`),
  KEY `idx_sys_attachment_file_id` (`file_id`),
  KEY `idx_sys_attachment_file_name` (`file_name`),
  KEY `idx_sys_attachment_org_id` (`org_id`),
  KEY `idx_sys_attachment_create_time` (`create_time`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='附件关联表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `sys_cloud_file`
--

DROP TABLE IF EXISTS `sys_cloud_file`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `sys_cloud_file` (
  ...
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`),
  KEY `idx_sys_cloud_file_create_time` (`create_time`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='云文件表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sys_code` (
  ...
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`code_id`)
) ENGINE=InnoDB AUTO_INCREMENT=26 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='系统编码表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=28 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='字典大类表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `sys_dict_big_type`
--

LOCK TABLES `sys_dict_big_type` WRITE;
/*!40000 ALTER TABLE `sys_dict_big_type` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `sys_dict_big_type` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `sys_dict_small_type` (
  ...
  KEY `idx_big_type_id` (`big_type_id`) /*!80000 INVISIBLE */,
  CONSTRAINT `fk_big_type_id_reference_sys_dict` FOREIGN KEY (`big_type_id`) REFERENCES `sys_dict_big_type` (`big_type_id`)
) ENGINE=InnoDB AUTO_INCREMENT=78 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='字典小类表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `sys_dict_small_type`
--

LOCK TABLES `sys_dict_small_type` WRITE;
/*!40000 ALTER TABLE `sys_dict_small_type` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `sys_dict_small_type` ENABLE KEYS */;
UNLOCK TABLES;
...
) ENGINE=InnoDB AUTO_INCREMENT=2008 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='地区表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sys_mod_opt_ref` (
  ...
  KEY `idx_module_id` (`module_id`) /*!80000 INVISIBLE */,
...
) ENGINE=InnoDB AUTO_INCREMENT=255 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='模块操作关系表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `sys_mod_opt_ref`
--

LOCK TABLES `sys_mod_opt_ref` WRITE;
/*!40000 ALTER TABLE `sys_mod_opt_ref` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `sys_mod_opt_ref` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `sys_module_menu` (
  ...
  KEY `idx_name` (`name`),
  KEY `idx_parent_id` (`parent_id`) /*!80000 INVISIBLE */,
  CONSTRAINT `fk_parent_id_reference_sys_memu` FOREIGN KEY (`parent_id`) REFERENCES `sys_module_menu` (`module_id`)
) ENGINE=InnoDB AUTO_INCREMENT=57 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='模块菜单表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `sys_module_menu` WRITE;
...
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='操作按钮表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `sys_operate`
--

LOCK TABLES `sys_operate` WRITE;
/*!40000 ALTER TABLE `sys_operate` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `sys_operate` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `sys_opt_log` (
  ...
  PRIMARY KEY (`opt_id`),
  KEY `idx_mod_name` (`mod_name`) /*!80000 INVISIBLE */,
  KEY `idx_create_date` (`create_time`),
  KEY `idx_user_name` (`user_name`),
  KEY `idx_user_role` (`user_role`),
  KEY `idx_org_id` (`org_id`)
) ENGINE=InnoDB AUTO_INCREMENT=201 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='系统操作日志表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sys_parameter` (
  ...
  PRIMARY KEY (`para_id`),
  KEY `idx_key` (`key`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='系统参数表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sys_resource` (
  ...
  KEY `idx_name` (`name`),
  KEY `idx_module_id` (`module_id`) /*!80000 INVISIBLE */,
  KEY `idx_operate_id` (`operate_id`) /*!80000 INVISIBLE */,
...
) ENGINE=InnoDB AUTO_INCREMENT=115 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='资源表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sys_scheduler_job` (
  ...
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`job_id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='定时任务表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `sys_scheduler_job`
--

LOCK TABLES `sys_scheduler_job` WRITE;
/*!40000 ALTER TABLE `sys_scheduler_job` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `sys_scheduler_job` ENABLE KEYS */;
UNLOCK TABLES;
...
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='表头配置表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `sys_table_config`
--

LOCK TABLES `sys_table_config` WRITE;
/*!40000 ALTER TABLE `sys_table_config` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `sys_table_config` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `uum_account` (
  ...
  KEY `idx_email` (`email`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='账号表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `uum_account`
--

LOCK TABLES `uum_account` WRITE;
/*!40000 ALTER TABLE `uum_account` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `uum_account` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `uum_captcha`
--

LOCK TABLES `uum_captcha` WRITE;
/*!40000 ALTER TABLE `uum_captcha` DISABLE KEYS */;
/*!40000 ALTER TABLE `uum_captcha` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `uum_department` (
  ...
  KEY `idx_parent_id` (`parent_id`) /*!80000 INVISIBLE */,
  KEY `idx_org_id` (`org_id`)
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='部门表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `uum_department`
--

LOCK TABLES `uum_department` WRITE;
/*!40000 ALTER TABLE `uum_department` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `uum_department` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `uum_organ` (
  ...
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`org_id`),
  KEY `idx_simple_name` (`simple_name`) USING BTREE,
  KEY `idx_parent_id` (`parent_id`) /*!80000 INVISIBLE */,
...
CREATE TABLE `uum_privilege` (
  ...
  KEY `idx_owner_type` (`owner_type`) USING BTREE /*!80000 INVISIBLE */,
  KEY `idx_privilege_type` (`privilege_type`)
) ENGINE=InnoDB AUTO_INCREMENT=452 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='权限表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `uum_user` (
  ...
  PRIMARY KEY (`user_id`),
  KEY `idx_org_id` (`org_id`),
  KEY `idx_account_id` (`account_id`) /*!80000 INVISIBLE */,
...
-- Dump completed on 2024-07-28  9:03:09
