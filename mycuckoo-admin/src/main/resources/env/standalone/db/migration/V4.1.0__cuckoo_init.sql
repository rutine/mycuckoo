...
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='公告附件表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `sys_accessory`
--

LOCK TABLES `sys_accessory` WRITE;
/*!40000 ALTER TABLE `sys_accessory` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `sys_accessory` ENABLE KEYS */;
UNLOCK TABLES;
